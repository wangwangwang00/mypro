  ...
  <div class="box">
    ...
    <div class="content">
      <div class="KanCompanyAreaLeft">
        <ul>
          <li v-for="(item, index) of industry" :key="index"  :class="{'active':ind === index}">{{ item.name }}</li>
        </ul>
      </div>
      <div class="KanCompanyAreaRight">
        <ul>
          <li v-for="(item, index) of industry1 " :key="index" :class="{'active':ind === index}">{{ item.name }}</li>
        </ul>
      </div>
    </div>
